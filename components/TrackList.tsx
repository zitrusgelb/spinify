  ...
  return (
    <div className="w-full h-screen p-5 overflow-y-scroll overflow-hidden scrollbar-styled">
      <div className="w-fit bg-gradient2 rounded-3xl content-center text-center p-5">
        ...
        <div className="text-sm font-bold text-left text-primary">Total duration: {millisToTime(totalDurationMs)}</div>
      </div>
...
function TrackElement({ track, index }: { track: Track; index: number }) {
  return (
    <div className="flex gap-5 pb-2 pt-2 w-full h-32 cursor-pointer hover:scale-101 transition duration-200">
